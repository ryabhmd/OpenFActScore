...
if __name__=="__main__":
    ...
    parser.add_argument("--is_npm", action="store_true", default=True, help="Enable NPM mode")
    ...
    parser.add_argument("--use_atomic_facts", action="store_true", default=True, help="Enable use of atomic facts")
